# Yama_UM_Hackathon_2026 (Y-Inventory)
UM hackathon 2026
...
1. **Clear the Audit Log:** Open `backend/data/audit_log.json` and clear its contents (reset it to an empty array `[]`). 
...
This allows you to easily simulate supply chain disruptions, VIP customer requests, or material shortages and instantly see how the AI reacts!
