...
const Suppliers = () => {
  const suppliers = [
    {
      id: "S001",
      name: "Bosch Preferred Supplier A",
      reliability: 98,
      speed: "Fast (2 days)",
      costLevel: "$$$",
      type: "Raw Materials",
    ...
    <div>
      ...
      <header className="page-header">
        ...
        <p className="page-subtitle">
          Compare and manage component suppliers and logistics partners.
        </p>{" "}
      </header>{" "}
      <div className="grid-cols-4" style={{ marginBottom: "2rem" }}>
        ...
        <div className="card">
          ...
          <div className="card-title">
            <ShieldCheck size={20} /> Active Partners
          </div>{" "}
        ...
        <div className="card">
          {" "}
          <div className="card-title">
            <Clock size={20} /> Avg Delivery Time
          </div>{" "}
        ...
        <div className="table-wrapper">
          ...
          <table className="table">
            ...
            <thead>
              ...
              <tr>
                {" "}
                <th>ID</th> <th>Supplier Name</th> <th>Category</th>{" "}
                <th>Reliability Score</th> <th>Delivery Speed</th>{" "}
                <th>Cost Level</th>{" "}
              </tr>{" "}
            </thead>{" "}
            <tbody>
